require(['./loading_img','subtitle','../lib/jquery-easing','./shakesnow'],function(mod_load,subtitle,easing,modshake){
            ...
            setTimeout(function(){
                ...
                $('.za_logo').stop().animate({'top':'-1.95rem'},{
                    ...
                    complete:function(){
                        $('.za_shadow').fadeIn();
                        setTimeout(function(){
                            subtitle.subtitle($('.mod-info').find('p'),3200,subtitleCb);
                        },2000);
                    }});
            },4500);
    ...
    //playControl.playControl($('.play'),$('audio'));
    function subtitleCb(){
        $('.mod-info').fadeOut();
        subtitle.subtitle($('.man'),1300,personCb);
        function personCb(){
                    ...
                    setTimeout(function(){
                        ...
                        setTimeout(function(){
                            ...
                            setTimeout(function(){
                                                ...
                                                setTimeout(function(){
                                                    ...
                                                    setTimeout(function(){
                                                        ...
                                                        function sceneBegin(){
                                                            $(c).remove();
                                                            $('.santa-man').fadeOut();
                                                            $('.scene').fadeIn(1000,sceneshow);
                                                            function sceneshow(){
                                                                //$('body').css({backgroundColor:'#071b34'});
                                                                activeindex = signStatus();
                                                                var swipelock = false;
                                                                var swipecount = 0;
                                                                var obj = $("div[sign-status='1']").eq(activeindex[0]);
                                                                function initswipe(obj,callback){
                                                                    obj.addClass('person-rotate-show');
                                                                    setTimeout(function () {
                                                                        obj.removeClass('person-rotate-on');
                                                                        swipecount++;
                                                                        callback&&callback();
                                                                        swipelock=true;
                                                                    }, 1800);
                                                                }
                                                                initswipe(obj,swipechange);
                                                                function swipechange(){
                                                                    switch (sceneStatus){
                                                                        case 'yydr':
                                                                            // PLAY SONG
                                                                            audioControl.audioplay($('#squaredance'));
                                                                            $('.bigmom').fadeIn();
                                                                            $('.dogmom').fadeIn();
                                                                            $('.dogdayemom').fadeIn();
                                                                            $('.bigmom-word').stop().fadeIn(3000,function(){
                                                                                setTimeout(function(){
                                                                                    $('.bigmom-word').stop().fadeOut();
                                                                                    $('.santa-face-yydr').fadeIn(1000,function(){
                                                                                        $('.santa-face-yydr').addClass('face-show');
                                                                                        setTimeout(function(){
                                                                                            $('.santa-face-yydr').fadeOut(500,function(){
                                                                                                audioControl.audioplay($('#deerrun'));
                                                                                                $('.santa-come').show();
                                                                                                $('.santa-come').addClass('santa-comeing');
                                                                                                $('.shake-hand-all').hide();
                                                                                                $('.hand').show();
                                                                                                setTimeout(function(){
                                                                                                    audioControl.audiopause($('#deerrun'));
                                                                                                    $('.santa-come').addClass('coming');

                                                                                                    $('.shake-mask').fadeIn(500,function(){

                                                                                                        $('.hand').addClass('shake-hand');
                                                                                                        setTimeout(function(){
                                                                                                            $('.bd').fadeIn(1000,function(){
                                                                                                                $('.shake-mask').fadeOut(800,function(){
                                                                                                                    $('.bigmom').fadeOut();
                                                                                                                    $('.bigmom-kick').fadeIn(1000,function(){
                                                                                                                        $('.dogmom').addClass('dogmom-fly');
                                                                                                                        setTimeout(function(){
                                                                                                                            $('.dogmom').fadeOut(1000,function(){
                                                                                                                                $('.bigmom-kick').fadeOut();
                                                                                                                                $('.dogdaye').addClass('dogdaye-happy');
                                                                                                                                setTimeout(function(){
                                                                                                                                    $('.bigmom-happy').fadeIn(100,function(){
                                                                                                                                        audioControl.audioplay($('#deerrun'));
                                                                                                                                        setTimeout(function(){
                                                                                                                                            audioControl.audiostop($('#deerrun'));
                                                                                                                                        },2000);
                                                                                                                                        $('.santa-come').fadeOut(500,function(){
                                                                                                                                            $('.santa-come').removeClass('coming')
                                                                                                                                        });
                                                                                                                                        $('.bigmom-msg').fadeIn(1000,function(){
                                                                                                                                            sceneStatus='jjh';
                                                                                                                                            $('.bd').hide();
                                                                                                                                            $('.hand').hide();
                                                                                                                                            if(swipecount<4){
                                                                                                                                            ...
                                                                                                                                            $('.big-mom').on('swipeleft',function(){
                                                                                                                                                audioControl.audiostop($('#squaredance'));
                                                                                                                                                $('.bigmom-msg').fadeOut();
                                                                                                                                                $('.swipe-word').fadeOut();
                                                                                                                                                if(!swipelock || swipecount==4)return;
                                                                                                                                                swipelock=false;
                                                                                                                                                $('.big-mom').addClass('person-rotate-hide').removeClass('person-rotate-show');
                                                                                                                                                setTimeout(function(){
                                                                                                                                                    $('.big-mom').hide();
                                                                                                                                                },1800);
                                                                                                                                                initswipe($('.oldwang'),swipechange);
                                                                                                                                            });
                                                                                                                                        });
                                                                                                                                    });
                                                                        ...
                                                                        case 'jjh':
                                                                            //oldwang play song
                                                                            $('.oldw-sf-word').stop().fadeIn(3000,function(){
                                                                                setTimeout(function(){
                                                                                    $('.oldw-sf-word').stop().fadeOut();
                                                                                    $('.santa-face-jjh').fadeIn(1000,function(){
                                                                                        $('.santa-face-jjh').addClass('face-show');
                                                                                        setTimeout(function(){
                                                                                            $('.santa-face-jjh').fadeOut(500,function(){
                                                                                                audioControl.audioplay($('#deerrun'));
                                                                                                $('.santa-come').show();
                                                                                                $('.santa-come').addClass('santa-comeing');
                                                                                                setTimeout(function(){
                                                                                                    ...
                                                                                                    $('.oldw-hand').show();
                                                                                                    $('.shake-mask').fadeIn(500,function(){
                                                                                                        $('.oldw-hand').addClass('shake-hand');
                                                                                                        setTimeout(function(){
                                                                                                            $('.thq').fadeIn(1000,function(){
                                                                                                                setTimeout(function(){
                                                                                                                    $('.shake-mask').fadeOut(1000,function(){
                                                                                                                        $('.thq').hide();
                                                                                                                        audioControl.audioplay($('#deerrun'));
                                                                                                                        setTimeout(function(){
                                                                                                                            audioControl.audiostop($('#deerrun'));
                                                                                                                        ...
                                                                                                                        $('.oldw-sf').fadeOut(2000);
                                                                                                                        $('.oldw').fadeIn(3000,function(){
                                                                                                                            sceneStatus='xb';
                                                                                                                            if(swipecount<4){
                                                                                                                                $('.swipe-word').fadeIn();
                                                                                                                            }else{
                                                                                                                            ...
                                                                                                                            $('.oldwang').on('swipeleft',function(){
                                                                                                                                $('.swipe-word').fadeOut();
                                                                                                                                if(!swipelock || swipecount==4)return;
                                                                                                                                swipelock=false;
                                                                                                                                $('.oldwang').addClass('person-rotate-hide').removeClass('person-rotate-show');
                                                                                                                                setTimeout(function(){
                                                                                                                                    $('.oldwang').hide();
                                                                                                                                },1800);
                                                                                                                                initswipe($('.xb'),swipechange);
                                                                                                                            });
                                                                                                                        });
                                                                                                                    });
                                                                                                                },1700)
                                                                            ...
                                                                            break;
                                                                        case 'xb':
                                                                            $('.xb-say1').fadeIn(2000,function(){
                                                                                setTimeout(function(){
                                                                                    $('.xb-say1').fadeOut(1000,function(){
                                                                                        $('.xj-word').fadeIn();
                                                                                        setTimeout(function(){
                                                                                            $('.xj-word').fadeOut(1000,function(){
                                                                                                $('.xb-say2').stop().fadeIn(2000,function(){
                                                                                                    setTimeout(function(){
                                                                                                        $('.xb-say2').stop().fadeOut();
                                                                                                        $('.santa-face-xb').fadeIn(1000,function(){
                                                                                                            $('.santa-face-xb').addClass('face-show');
                                                                                                            setTimeout(function(){
                                                                                                                $('.santa-face-xb').fadeOut(500,function(){
                                                                                                                    audioControl.audioplay($('#deerrun'));
                                                                                                                    $('.santa-come').show();
                                                                                                                    $('.santa-come').addClass('santa-comeing');
                                                                                                                    setTimeout(function(){
                                                                                                                        ...
                                                                                                                        $('.shake-mask').fadeIn(500,function(){
                                                                                                                            ...
                                                                                                                            setTimeout(function(){
                                                                                                                                $('.shake-mask').fadeOut(1000,function(){
                                                                                                                                    ...
                                                                                                                                    setTimeout(function(){
                                                                                                                                        $('.xb-word').stop().fadeOut();
                                                                                                                                        $('.xb-begin').fadeOut(2000);
                                                                                                                                        $('.xb-end').fadeIn(3000,function(){
                                                                                                                                            $('.xj-say').stop().fadeIn();
                                                                                                                                            sceneStatus='jk';
                                                                                                                                            if(swipecount<4){
                                                                                                                                                $('.swipe-word').fadeIn();
                                                                                                                                            ...
                                                                                                                                            $('.xb').on('swipeleft',function(){
                                                                                                                                                $('.swipe-word').fadeOut();
                                                                                                                                                if(!swipelock || swipecount==4)return;
                                                                                                                                                swipelock=false;
                                                                                                                                                $('.xb').addClass('person-rotate-hide').removeClass('person-rotate-show');
                                                                                                                                                setTimeout(function(){
                                                                                                                                                    $('.xb').hide();
                                                                                                                                                },1800);
                                                                                                                                                initswipe($('.lostphoneboy'),swipechange);
                                                                                                                                            });
                                                                                                                                        });
                                                                                                                                    },1500);
                                                                                                                                });
                                                                        ...
                                                                        case 'jk':
                                                                            setTimeout(function(){
                                                                                $('.lostboy-msg').fadeIn(500,function(){
                                                                                    setTimeout(function(){
                                                                                        $('.lostboy-msg').fadeOut(500,function(){
                                                                                            $('.santa-face-jk').fadeIn(1000,function(){
                                                                                                $('.santa-face-jk').addClass('face-show');
                                                                                                setTimeout(function(){
                                                                                                    $('.santa-face-jk').fadeOut(500,function(){
                                                                                                        audioControl.audioplay($('#deerrun'));
                                                                                                        $('.santa-come').show();
                                                                                                        $('.santa-come').addClass('santa-comeing');
                                                                                                        ...
                                                                                                        setTimeout(function(){
                                                                                                            ...
                                                                                                            $('.boy-hand').show();
                                                                                                            $('.shake-mask').fadeIn(500,function(){
                                                                                                                $('.boy-hand').addClass('shake-hand');
                                                                                                                setTimeout(function(){
                                                                                                                    $('.linkman').fadeIn(2000,function(){
                                                                                                                        setTimeout(function(){
                                                                                                                            $('.shake-mask').fadeOut(1000,function(){
                                                                                                                                $('.linkman').hide();
                                                                                                                                $('.boylost').stop().fadeOut(1000);
                                                                                                                                $('.boytap').stop().fadeIn(1000,function(){
                                                                                                                                    setTimeout(function(){
                                                                                                                                        audioControl.audioplay($('#deerrun'));
                                                                                                                                        setTimeout(function(){
                                                                                                                                            audioControl.audiostop($('#deerrun'));
                                                                                                                                        },2000);
                                                                                                                                        $('.santa-come').fadeOut(1000,function(){
                                                                                                                                            $('.santa-come').removeClass('coming');
                                                                                                                                            $('.boygodness').fadeIn(1300,function(){
                                                                                                                                                sceneStatus='yydr';
                                                                                                                                                if(swipecount<4){
                                                                                                                                                    $('.swipe-word').fadeIn();
                                                                                                                                                }else{
                                                                                                                                                ...
                                                                                                                                                $('.lostphoneboy').on('swipeleft',function(){
                                                                                                                                                    $('.swipe-word').fadeOut();
                                                                                                                                                    if(!swipelock || swipecount==4) return;
                                                                                                                                                    swipelock=false;
                                                                                                                                                    $('.lostphoneboy').addClass('person-rotate-hide').removeClass('person-rotate-show');
                                                                                                                                                    setTimeout(function(){
                                                                                                                                                        $('.lostphoneboy').hide();
                                                                                                                                                    },1800);
                                                                                                                                                    initswipe($('.big-mom'),swipechange);
                                                                                                                                                });
                                                                                                                                            });
                                                                                                                                        });
                                ...
                                //subtitle.subtitle($('.light'),1100,lightend);
    ...
    function transfromwish(){
        $('.bottomball').addClass('back');
        $('.scene-ball').addClass('backsmall');
        setTimeout(function(){
            $('.scene').fadeOut();
    ...
    function wishBegin(){
        ...
        $('.wish-sendall').click(function(){
            ...
            if (/iphone|ipad|ipod/.test(ua)) {
                //console.log('这是小苹果');
                $('.wish-mywish').css('background','url("../images/wish-mywishios.png") no-repeat cover');
                $('.wish-mywish-reload').hide();
                $('.wish-mywish-share').css('left','8.25rem');

            } else if (/android/.test(ua)) {
                $('.wish-mywish').css('background','url("../../images/wish-mywish1.png") no-repeat cover')
            }
        });
